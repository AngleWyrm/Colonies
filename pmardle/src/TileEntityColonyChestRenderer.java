...
public class TileEntityColonyChestRenderer extends TileEntitySpecialRenderer {
	...
	public TileEntityColonyChestRenderer() {
	...
	public void render(TileEntityColonyChest tile, double x, double y, double z, float partialTick) {
		if (tile == null) {
			return;
		}
		int facing = 3;
		ColonyChestType type = tile.getType();
		if (tile != null && tile.getWorldObj() != null) {
			facing = tile.getFacing();
			type = tile.getType();
			int typ = tile.getWorldObj().getBlockMetadata(tile.xCoord, tile.yCoord, tile.zCoord);
			type = ColonyChestType.values()[typ];
		}
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float partialTick) {
		render((TileEntityColonyChest) tileentity, x, y, z, partialTick);
	}
